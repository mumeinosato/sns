...
describe("KintoneRestAPIClient", function () {
    describe("constructor", function () {
        ...
        describe("socketTimeout", function () {
            var baseUrl = "https://example.com";
            var auth = { apiToken: "foo" };
            it("should not throw an error", function () {
                var validSocketTimeout = [undefined, 100, "100"];
                validSocketTimeout.forEach(function (socketTimeout) {
                    expect(function () {
                        return new KintoneRestAPIClient_1.KintoneRestAPIClient({
                            baseUrl: baseUrl,
                            auth: auth,
            ...
            it("should throw an error", function () {
                var invalidSocketTimeout = ["abc", -100];
                invalidSocketTimeout.forEach(function (socketTimeout) {
                    expect(function () {
                        // @ts-ignore
                        return new KintoneRestAPIClient_1.KintoneRestAPIClient({ baseUrl: baseUrl, auth: auth, socketTimeout: socketTimeout });
